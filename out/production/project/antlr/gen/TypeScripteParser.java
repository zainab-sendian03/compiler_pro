...
public class TypeScripteParser extends Parser {
	...
	public static final int
		WS=1, LINE_COMMENT=2, BLOCK_COMMENT=3, TEMPLATE_LITERAL=4, IMPORT=5, FROM=6, 
		EXPORT=7, CLASS=8, COMPONENT=9, MYSTRING=10, IF=11, ELSE=12, FOR=13, INT=14, 
		VAR=15, SELECTOR=16, TEMPLATE=17, IMPORTS=18, STANDALONE=19, CONST=20, 
		LET=21, TRUE=22, FALSE=23, NULL=24, AT=25, LBRACE=26, RBRACE=27, LBRACKET=28, 
		RBRACKET=29, LPAREN=30, RPAREN=31, COLON=32, COMMA=33, SEMICOLON=34, DOT=35, 
		PLUS=36, MINUS=37, STAR=38, MOD=39, EQUALS=40, BOOLEAN=41, VOID=42, BACKTICK=43, 
		PIPE=44, ARROW=45, OPEN_SYMBOL=46, CLOSED_SYMBOL=47, SLASHSELF=48, STRING=49, 
		NUMBER=50, IDENTIFIER=51, ANGULAR_EXPRESSION=52, TAG_NAME=53, SPASE=54, 
		SLASH=55;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, null, null, null, null, "'import'", "'from'", "'export'", "'class'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "WS", "LINE_COMMENT", "BLOCK_COMMENT", "TEMPLATE_LITERAL", "IMPORT", 
			"FROM", "EXPORT", "CLASS", "COMPONENT", "MYSTRING", "IF", "ELSE", "FOR", 
			"INT", "VAR", "SELECTOR", "TEMPLATE", "IMPORTS", "STANDALONE", "CONST", 
			"LET", "TRUE", "FALSE", "NULL", "AT", "LBRACE", "RBRACE", "LBRACKET", 
			"RBRACKET", "LPAREN", "RPAREN", "COLON", "COMMA", "SEMICOLON", "DOT", 
			"PLUS", "MINUS", "STAR", "MOD", "EQUALS", "BOOLEAN", "VOID", "BACKTICK", 
			"PIPE", "ARROW", "OPEN_SYMBOL", "CLOSED_SYMBOL", "SLASHSELF", "STRING", 
			"NUMBER", "IDENTIFIER", "ANGULAR_EXPRESSION", "TAG_NAME", "SPASE", "SLASH"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3940651149356192L) != 0)) {
				{
				{
				setState(94);
				statement();
	...
	public final ComponentBodyContext componentBody() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 2251799814668288L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ImportsFieldContext importsField() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3956043201643520L) != 0)) {
				{
				{
				setState(163);
				primitiveType();
	...
	public final PropertyDeclarationContext propertyDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3956043201643520L) != 0)) {
				{
				setState(196);
				type();
				}
	...
	public final LiteralContext literal() throws RecognitionException {
		...
		try {
			...
			setState(269);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1688849889624064L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final ArrayLiteralContext arrayLiteral() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3940651115791360L) != 0)) {
				{
				setState(272);
				expression();
				setState(277);
	...
	public final VariableDeclarationContext variableDeclaration() throws RecognitionException {
		...
		try {
			...
			case LET:
				...
				setState(426);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 3195904L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final SelfClosingTagContext selfClosingTag() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2252076033769472L) != 0)) {
				{
				{
				setState(453);
				content();
