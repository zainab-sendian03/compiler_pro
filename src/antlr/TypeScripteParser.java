...
public class TypeScripteParser extends Parser {
	...
	public final ImportsFieldContext importsField() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3947247108621328L) != 0)) {
				{
				{
				setState(157);
				primitiveType();
	...
	public final PropertyDeclarationContext propertyDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3947247108621328L) != 0)) {
				{
				setState(190);
				type();
				}
	...
	public static class PrimitiveTypeContext extends ParserRuleContext {
		...
		public TerminalNode IDENTIFIER() { return getToken(TypeScripteParser.IDENTIFIER, 0); }
		public TerminalNode TEMPLATE_LITERAL() { return getToken(TypeScripteParser.TEMPLATE_LITERAL, 0); }
